...
exports.run = async (client, message, args, color) => {  
  ...
  bl.send(`**${pUser.username}** \`${pUser.id}\` has been excluded from using the bot.`)
  blk.send(`**${pUser.username}** \`${pUser.id}\` has been excluded from using the bot.`)
  message.delete()
  message.channel.send(`**${pUser.username}** \`${pUser.id}\` has been excluded from using the bot.`);
