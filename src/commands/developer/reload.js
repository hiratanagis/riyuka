...
exports.run = async (client, message, args) => {
  ...
  if(!command) return msg.channel.send(`<a:Silang:571969696954581006> The command \`${args[1]}\` doesn't seem to exist, nor is it an alias. Try again!`);
  ...
  msg.channel.send(`<a:Centang:571969673436856330> The command \`${command}\` has been reloaded`);
  });
};
